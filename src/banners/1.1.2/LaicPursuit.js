  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        />
        <LazyLoadImage
          src="../assets/banner/1.1.2/char-banner-back.webp"
          width={getWidth(1200)}
          alt="right"
          draggable="false"
          style={{
      ...
      <LazyLoadImage
        effect="opacity-100"
        src={`../assets/banner/1.1.2/${i18n.resolvedLanguage}/char-left.webp`}
        width={getWidth(331)}
        alt="left"
        draggable="false"
        style={{
      ...
      />
      <LazyLoadImage
        src="../assets/banner/1.1.2/main-char.webp"
        width={getWidth(1200)}
        alt="char"
        draggable="false"
        style={{
      ...
      />
      <RateModal show={show} setShow={setShow} vers="1.1.2" type="char" />
      <Button
        style={{
          position: "absolute",
          top: "50%",
