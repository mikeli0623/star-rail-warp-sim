...
export default function BrilliantFixationB() {
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <LazyLoadImage
          effect="opacity"
          src="../assets/banner/1.2.0/weap-banner-back.webp"
          width={getWidth(1200)}
          alt="right"
          draggable="false"
          style={{
            animation: "blade-weap-back-animation 3s 100ms 1",
      ...
      <LazyLoadImage
        ...
        src="../assets/banner/rate-up/swordplay.webp"
      ...
      <LazyLoadImage
        className="weap-rate-up"
        src="../assets/banner/rate-up/shared-feeling.webp"
        alt="Geniuses Repose"
        width={getWidth(108)}
        style={{
          animationTimingFunction: "linear",
      ...
      <LazyLoadImage
        className="weap-rate-up"
        src="../assets/banner/rate-up/a-secret-vow.webp"
      ...
      <LazyLoadImage
        effect="opacity-100"
        src={`../assets/banner/1.2.0/${i18n.resolvedLanguage}/weap-left.webp`}
      ...
      <LazyLoadImage
        ...
        draggable="false"
      />
      <RateModal show={show} setShow={setShow} vers="1.2.0" type="weap" />
      <Button
        style={{
          position: "absolute",
          top: "50%",
