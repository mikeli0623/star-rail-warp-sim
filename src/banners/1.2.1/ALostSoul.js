...
export default function ALostSoul() {
  ...
  return (
    <React.Fragment>
      ...
      >
        <div
          style={{
            backgroundImage: "url(../assets/banner/rate-up/natasha.webp)",
            width: getWidth(1000),
      ...
      />
      <LazyLoadImage
        src="../assets/banner/1.2.1/main-char.webp"
        width={getWidth(1100)}
        alt="char"
        draggable="false"
        style={{
          ...
          top: "50%",
          left: "50%",
          animation: "blade-animation 3s 200ms 1",
          animationTimingFunction: "cubic-bezier(.27,.42,.2,.97)",
          animationFillMode: "both",
        }}
      />
      <RateModal show={show} setShow={setShow} vers="1.2.1" type="char" />
      <Button
        style={{
          position: "absolute",
          top: "50%",
