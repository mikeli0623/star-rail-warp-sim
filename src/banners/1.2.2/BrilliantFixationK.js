  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <LazyLoadImage
          effect="opacity"
          src="../assets/banner/1.2.2/main-weap.webp"
          width={getWidth(1200)}
          alt="right"
          draggable="false"
          style={{
            animation: "kafka-weap-back-animation 3s 100ms 1",
      ...
      <LazyLoadImage
        effect="opacity-100"
        src={`../assets/banner/1.2.2/${i18n.resolvedLanguage}/weap-left.webp`}
      ...
      <LazyLoadImage
        ...
        draggable="false"
      />
      <RateModal show={show} setShow={setShow} vers="1.2.2" type="weap" />
      <Button
        style={{
          position: "absolute",
          top: "50%",
