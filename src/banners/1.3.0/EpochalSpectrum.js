...
export default function EpochalSpectrum() {
  ...
  return (
    <React.Fragment>
      ...
      <LazyLoadImage
        effect="opacity-100"
        src={`../assets/banner/1.3.0/${i18n.resolvedLanguage}/char-left.webp`}
        width={getWidth(331)}
        alt="left"
        draggable="false"
        style={{
      ...
      />
      <LazyLoadImage
        src="../assets/banner/1.3.0/main-char.webp"
        width={getWidth(1200)}
        alt="char"
        draggable="false"
        style={{
      ...
      />
      <RateModal show={show} setShow={setShow} vers="1.3.0" type="char" />
      <Button
        style={{
          position: "absolute",
          top: "50%",
