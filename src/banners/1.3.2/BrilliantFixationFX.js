...
export default function BrilliantFixationFX() {
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <LazyLoadImage
          effect="opacity"
          src="../assets/banner/1.3.2/main-weap.webp"
          width={getWidth(1000)}
          alt="right"
          draggable="false"
          style={{
            animation: "fu-xuan-weap-back-animation 3s 100ms 1",
      ...
      <LazyLoadImage
        ...
        src="../assets/banner/rate-up/perfect-timing.webp"
        alt="Perfect Timing"
        width={getWidth(135)}
        style={{
      ...
      <LazyLoadImage
        className="weap-rate-up"
        src="../assets/banner/rate-up/under-the-blue-sky.webp"
        alt="Under the Blue Sky"
        width={getWidth(108)}
        style={{
          animationTimingFunction: "linear",
      ...
      <LazyLoadImage
        className="weap-rate-up"
        src="../assets/banner/rate-up/trend-of-the-universal-market.webp"
        alt="Trend of the Universal Market"
        width={getWidth(108)}
        style={{
          animationTimingFunction: "linear",
      ...
      <LazyLoadImage
        effect="opacity-100"
        src={`../assets/banner/1.3.2/${i18n.resolvedLanguage}/weap-left.webp`}
      ...
      <LazyLoadImage
        ...
        draggable="false"
      />
      <RateModal show={show} setShow={setShow} vers="1.3.2" type="weap" />
      <Button
        style={{
          position: "absolute",
          top: "50%",
