  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        />
        {/* <LazyLoadImage
          src="../assets/banner/1.2.1/char-banner-back.webp"
          width={getWidth(1200)}
          alt="right"
          draggable="false"
          style={{
      ...
      >
        <div
          style={{
            backgroundImage: "url(../assets/banner/rate-up/lynx.webp)",
            width: getWidth(1100),
            height: getWidth(1100),
            backgroundSize: getWidth(1100),
            position: "absolute",
            animation: "lynx-animation 1s 1",
            animationTimingFunction: "cubic-bezier(.27,.42,.2,.97)",
      ...
      >
        <div
          style={{
            backgroundImage: "url(../assets/banner/rate-up/hook.webp)",
            width: getWidth(1100),
            height: getWidth(1100),
            backgroundSize: getWidth(1100),
            position: "absolute",
      ...
      <LazyLoadImage
        effect="opacity-100"
        src={`../assets/banner/1.3.2/${i18n.resolvedLanguage}/char-left.webp`}
        width={getWidth(331)}
        alt="left"
        draggable="false"
        style={{
      ...
      />
      <LazyLoadImage
        src="../assets/banner/1.3.2/main-char.webp"
        width={getWidth(1200)}
        alt="char"
        draggable="false"
        style={{
      ...
      />
      <RateModal show={show} setShow={setShow} vers="1.3.2" type="char" />
      <Button
        style={{
          position: "absolute",
          top: "50%",
