  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <LazyLoadImage
          effect="opacity"
          src="../assets/banner/1.4.2/main-weap.webp"
          width={getWidth(1000)}
          alt="right"
          draggable="false"
          style={{
      ...
      <LazyLoadImage
        effect="opacity-100"
        src={`../assets/banner/1.4.2/${i18n.resolvedLanguage}/weap-left.webp`}
      ...
      <LazyLoadImage
        ...
        draggable="false"
      />
      <RateModal show={show} setShow={setShow} vers="1.4.2" type="weap" />
      <Button
        style={{
          position: "absolute",
          top: "50%",
