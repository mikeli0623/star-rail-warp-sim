...
export default function Banner152() {
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        />
        <LazyLoadImage
          src="../assets/banner/1.5.2/char-banner-back.webp"
          width={getWidth(1200)}
          alt="right"
          draggable="false"
          style={{
            position: "relative",
            animation: "argenti-back-animation 3s 200ms 1",
      ...
      >
        <div
          style={{
            backgroundImage: "url(../assets/banner/rate-up/hanya.webp)",
            width: getWidth(900),
            height: getWidth(900),
            backgroundSize: getWidth(900),
            position: "absolute",
            animation: "hanya-animation 1s 1",
            animationTimingFunction: "cubic-bezier(.27,.42,.2,.97)",
      ...
      <LazyLoadImage
        effect="opacity-100"
        src={`../assets/banner/1.5.2/${i18n.resolvedLanguage}/char-left.webp`}
        width={getWidth(331)}
        alt="left"
        draggable="false"
        style={{
      ...
      />
      <LazyLoadImage
        src="../assets/banner/1.5.2/main-char.webp"
        width={getWidth(1200)}
        alt="char"
        draggable="false"
        style={{
      ...
      />
      <RateModal show={show} setShow={setShow} vers="1.5.2" type="char" />
      <Button
        style={{
          position: "absolute",
          top: "50%",
