...
const CloseButton = ({ onClose, style, variant = "light", resize = true }) => {
  ...
  return (
    <div
      ...
      style={{
        ...style,
        width: resize ? getWidth(70) : 70,
        height: resize ? getWidth(70) : 70,
        paddingLeft: resize ? getWidth(12) : 12,
      }}
      onClick={() => {
        onClose();
        if (sound) play();
    ...
    >
      <div style={{ marginRight: resize ? getWidth(16) : 16 }}>
        <div
          className="button-leg top-left"
          style={{
            width: resize ? getWidth(6) : 6,
            height: resize ? getHeight(38, 6) : 38,
      ...
      <div>
        <div
          id="button-dot"
          style={{
            width: resize ? getWidth(10) : 10,
            height: resize ? getWidth(10) : 10,
            backgroundColor: variant === "dark" && "#0e110e",
          }}
        />
      </div>
      <div style={{ marginLeft: resize ? getWidth(16) : 16 }}>
        <div
